...
var TechnicalAnalysis403 = function (_a) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-8">
              <react_router_dom_1.Link to="/dashboard" className="text-2xl font-bold text-primary-600 dark:text-primary-400">
                📈 StockAnalyzer
              </react_router_dom_1.Link>
              <div className="hidden md:flex space-x-4">
                <react_router_dom_1.Link to="/dashboard" className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400">
                  Dashboard
                </react_router_dom_1.Link>
                <react_router_dom_1.Link to="/watchlist" className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400">
                  Watchlist
                </react_router_dom_1.Link>
                <react_router_dom_1.Link to="/technical-analysis" className="text-primary-600 dark:text-primary-400 font-semibold">
                  Technical Analysis
                </react_router_dom_1.Link>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <button onClick={onLogout} className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400">
                Logout
              </button>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white dark:bg-gray-700 rounded-lg shadow-lg dark:shadow-gray-200/20 p-8 border dark:border-gray-500 mb-8">
          <div className="text-center mb-8">
            ...
            {user && (<p className="text-lg text-gray-500 dark:text-gray-400">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-gradient-to-br from-primary-50 to-purple-50 dark:from-gray-800 dark:to-gray-800 rounded-lg p-6 border border-primary-200 dark:border-gray-600 mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <react_router_dom_1.Link to="/pricing" className="flex-1 px-6 py-3 bg-gradient-to-r from-primary-600 to-purple-600 text-white font-semibold rounded-lg hover:from-primary-700 hover:to-purple-700 transition-all text-center shadow-lg">
                  Upgrade to Enterprise
                </react_router_dom_1.Link>
                <react_router_dom_1.Link to="/dashboard" className="flex-1 px-6 py-3 bg-gray-200 dark:bg-gray-600 text-gray-900 dark:text-white font-semibold rounded-lg hover:bg-gray-300 dark:hover:bg-gray-500 transition-all text-center">
                  Back to Dashboard
                </react_router_dom_1.Link>
              </div>
            </div>
...
exports.default = TechnicalAnalysis403;
