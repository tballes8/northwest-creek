        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/alerts" className="text-gray-300 hover:text-white">Alerts</Link>
              <Link to="/stocks" className="text-gray-300 hover:text-white">Stocks</Link>
              <Link to={`/technical-analysis${ticker ? `?ticker=${ticker}` : ''}`} className="text-primary-400 dark:text-primary-400 font-medium border-b-2 border-primary-600 dark:border-primary-400 pb-1">Technical Analysis</Link>
              <Link to={`/dcf-valuation${ticker ? `?ticker=${ticker}` : ''}`} className="text-gray-300 hover:text-white">DCF Valuation</Link>
            </div>
