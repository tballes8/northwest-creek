...
var Landing = function () {
    return (<div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      {/* Navbar */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <react_router_dom_1.Link to="/login" className="text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                Sign In
              </react_router_dom_1.Link>
              <react_router_dom_1.Link to="/register" className="bg-primary-600 hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors shadow-sm">
                Get Started Free
              </react_router_dom_1.Link>

              <ThemeToggle_1.default />  {/* ADD THIS */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <div className="mt-10 flex justify-center gap-4">
            <react_router_dom_1.Link to="/register" className="px-8 py-4 bg-primary-600 hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 text-white text-lg font-semibold rounded-lg shadow-lg transition-colors">
              Start Free Trial
            </react_router_dom_1.Link>
            <react_router_dom_1.Link to="/login" className="px-8 py-4 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-primary-600 dark:text-primary-400 text-lg font-semibold rounded-lg shadow-lg border-2 border-primary-600 dark:border-primary-500 transition-colors">
              Sign In
            </react_router_dom_1.Link>
          </div>
        </div>
        ...
        <div className="mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-25xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-600 p-8 rounded-xl shadow-lg dark:shadow-gray-200/50 hover:shadow-xl transition-shadow border dark:border-gray-300">
              ...
              <react_router_dom_1.Link to="/register" className="block w-full text-center bg-primary-600 hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 text-white font-semibold py-3 rounded-lg transition-colors">
                Try For Free
              </react_router_dom_1.Link>
            </div>
            ...
            <div className="bg-white dark:bg-gray-600 p-8 rounded-xl shadow-lg dark:shadow-gray-200/50 hover:shadow-xl transition-shadow border dark:border-gray-300 relative transform scale-105">
              ...
              <react_router_dom_1.Link to="/registerwithpayment" className="block w-full text-center bg-primary-600 hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 text-white font-semibold py-3 rounded-lg transition-colors">
                Get Started Now
              </react_router_dom_1.Link>
            </div>
        ...
        <div className="mt-32 bg-primary-600 dark:bg-primary-700 rounded-2xl p-12 text-center">
          ...
          <react_router_dom_1.Link to="/register" className="inline-block px-8 py-4 bg-white hover:bg-gray-100 text-primary-600 text-lg font-semibold rounded-lg shadow-lg transition-colors">
