...
var Stocks = function () {
    ...
    var initialTicker = searchParams.get('ticker') || '';
    var _a = (0, react_1.useState)(null), user = _a[0], setUser = _a[1];
    var _b = (0, react_1.useState)(initialTicker), ticker = _b[0], setTicker = _b[1];
    var _c = (0, react_1.useState)(initialTicker), searchInput = _c[0], setSearchInput = _c[1];
    var _d = (0, react_1.useState)(null), quote = _d[0], setQuote = _d[1];
    var _e = (0, react_1.useState)(null), company = _e[0], setCompany = _e[1];
    var _f = (0, react_1.useState)([]), historical = _f[0], setHistorical = _f[1];
    var _g = (0, react_1.useState)(false), loading = _g[0], setLoading = _g[1];
    var _h = (0, react_1.useState)(''), error = _h[0], setError = _h[1];
    var _j = (0, react_1.useState)(30), historyDays = _j[0], setHistoryDays = _j[1];
    ...
    var loadStockData = function (symbol) { return __awaiter(void 0, void 0, void 0, function () {
        var token, headers, _a, quoteRes, companyRes, historicalRes, err_1;
        var _b, _c;
            ...
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            axios_1.default.get("http://localhost:8000/api/v1/stocks/".concat(symbol.toUpperCase(), "/quote"), { headers: headers }),
                            axios_1.default.get("http://localhost:8000/api/v1/stocks/".concat(symbol.toUpperCase(), "/company"), { headers: headers }),
                            axios_1.default.get("http://localhost:8000/api/v1/stocks/".concat(symbol.toUpperCase(), "/historical?days=").concat(historyDays), { headers: headers }),
                        ])];
                case 2:
                    _a = _d.sent(), quoteRes = _a[0], companyRes = _a[1], historicalRes = _a[2];
                ...
                case 3:
                    err_1 = _d.sent();
                    setError(((_c = (_b = err_1.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.detail) || 'Failed to fetch stock data. Please check the ticker symbol and try again.');
                    setQuote(null);
                    setCompany(null);
                    setHistorical([]);
                    return [3 /*break*/, 5];
    ...
    var handleSearch = function (e) {
        e.preventDefault();
        if (searchInput.trim()) {
            navigate("/stocks?ticker=".concat(searchInput.toUpperCase()));
    ...
    var formatLargeNumber = function (value) {
        if (value >= 1e12)
            return "$".concat((value / 1e12).toFixed(2), "T");
        if (value >= 1e9)
    ...
    var getChartData = function () {
        if (!historical.length)
            return null;
        var dates = historical.map(function (h) { return h.date; });
        var prices = historical.map(function (h) { return h.close; });
        return {
            labels: dates,
            datasets: [
                {
    ...
    return (<div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <react_router_dom_1.Link to="/stocks" className="text-primary-400 font-medium border-b-2 border-primary-400 pb-1">Stocks</react_router_dom_1.Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Stock Data */}
        {quote && company && (<div className="space-y-6">
            {/* Quote Card */}
            <div className="bg-white dark:bg-gray-700 rounded-lg shadow-lg dark:shadow-gray-200/20 p-6 border dark:border-gray-500">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="text-right">
                  ...
                  <div className={"text-lg font-semibold mt-1 ".concat(quote.change >= 0 ? 'text-green-600' : 'text-red-600')}>
            ...
            <div className="bg-white dark:bg-gray-700 rounded-lg shadow-lg dark:shadow-gray-200/20 p-6 border dark:border-gray-500">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-2">
                  {[30, 90, 180, 365].map(function (days) { return (<button key={days} onClick={function () {
                    setHistoryDays(days);
                    if (ticker)
                        loadStockData(ticker);
                }} className={"px-4 py-2 rounded-lg text-sm font-medium transition-colors ".concat(historyDays === days
              ...
              <div style={{ height: '400px' }}>
                {getChartData() && <react_chartjs_2_1.Line data={getChartData()} options={chartOptions}/>}
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <react_router_dom_1.Link to={"/technical-analysis?ticker=".concat(ticker)} className="flex-1 px-6 py-3 bg-primary-600 hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 text-white text-center rounded-lg font-medium transition-colors">
                Technical Analysis
              </react_router_dom_1.Link>
              <react_router_dom_1.Link to={"/dcf-valuation?ticker=".concat(ticker)} className="flex-1 px-6 py-3 bg-purple-600 hover:bg-purple-700 dark:bg-purple-500 dark:hover:bg-purple-600 text-white text-center rounded-lg font-medium transition-colors">
                DCF Valuation
              </react_router_dom_1.Link>
            </div>
          </div>)}
        ...
        {/* Empty State */}
        {!quote && !loading && !error && (<div className="bg-white dark:bg-gray-700 rounded-lg shadow-lg dark:shadow-gray-200/20 p-12 border dark:border-gray-500 text-center">
            ...
            <div className="flex justify-center gap-4">
              <button onClick={function () { setSearchInput('AAPL'); loadStockData('AAPL'); }} className="px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-500">
                Try AAPL
              </button>
              <button onClick={function () { setSearchInput('TSLA'); loadStockData('TSLA'); }} className="px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-500">
                Try TSLA
              </button>
              <button onClick={function () { setSearchInput('MSFT'); loadStockData('MSFT'); }} className="px-4 py-2 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-500">
                Try MSFT
              </button>
            </div>
          </div>)}
