...
FMP_ENDPOINTS: list[dict[str, Any]] = [
    ...
    {"path": "balance-sheet-statement", "description": "Quarterly/annual balance sheet",
     ...
     "key_fields": ["date", "totalDebt", "cashAndCashEquivalents", "totalAssets", "totalEquity"]},
    ...
    {"path": "ratios-ttm", "description": "Trailing-twelve-month financial ratios",
     ...
     "key_fields": ["peRatioTTM", "priceToSalesRatioTTM", "dividendYielTTM", "dividendPerShareTTM"]},
    ...
    {"path": "analyst-estimates", "description": "EPS/revenue analyst estimates",
     "used_by": ["api/v1/endpoints/stocks.py:1353", "api/v1/endpoints/dcf_valuation.py:52"],
     "key_fields": ["date", "estimatedRevenueAvg", "estimatedEpsAvg"]},
